...
public class HolidayDAOImpl implements GeniriqueDAOI<Holiday>,DataImportExport<Holiday>{
    ...
    public List<String> fetchSingleColumn(String sql, String columnLabel) {
